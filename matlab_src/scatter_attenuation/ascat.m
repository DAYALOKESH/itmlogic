function prop = ascat(d, prop)
% ASCAT - Scatter attenuation computation
%
...
%   prop - Structure containing all input and output propagation parameters
    ...
    if prop.h0s > 15
        ...
        th = prop.the(1) + prop.the(2) + d * prop.gme;
        r2 = 2 * prop.wn * th;
        ...
        if et < 1
            h0 = et * h0 + (1 - et) * 4.343 * log(((1 + 1.4142 / r1) * ...
    ...
    prop.ascat1 = ahd(th * d) + 4.343 * log(47.7 * prop.wn * th^4) - ...
