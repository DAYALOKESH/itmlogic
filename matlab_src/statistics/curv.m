...
% CURV - Empirical curve fit function
%
...
% in equations (5.5) through (5.7) of "The ITS Irregular Terrain Model, version 1.2.2:
% The Algorithm" and as captured in Figure 10.13 of NBS Technical Note 101.
%
% Parameters:
%   c1, c2, x1, x2, x3 - Curve fit coefficients
%   de - Distance parameter
%
% Returns:
%   cout - Curve fit value

    cout = (c1 + c2 / (1 + ((de - x2) / x3)^2)) * ...
        ((de / x1)^2) / (1 + (de / x1)^2);
end
